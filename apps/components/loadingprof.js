...
export default class loadingprof extends Component {
 constructor(props) {
  super(props);
  this.state = {
    place: {},
 ...
 getCity(location) {
  ...
  //  })
   .then(() => {
    ...
    setTimeout(() => Actions.menu({ kecamatan: this.state.place, type:'reset' }), 8000);
   })
 ...
 render() {
  return (
   ...
   >
    ...
    <Text style={styles.text} >Getting your profile . . .</Text>
   </LinearGradient>
  );
 }
}
